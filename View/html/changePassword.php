...
if(isSubmitted())
{
    ...
    changePassword($userId, $actualPassword, $newPassword, $passwordConfirmation);
}
        ...
        <div class="col-8">
            ...
            <form class="border p-5" action="" method="POST">
                <div class="form-group">
                    <label for="password">Mot de passe actuel <span class="text-danger">*</span></label>
                    ...
                    <span class="text-danger"><?php if (isset($_GET["actualPasswordError"])) echo $_GET["actualPasswordError"] ?></span>
                </div>
                <div class="form-group">
